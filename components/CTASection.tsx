  ...
  return (
    <section id="contact" className="py-24 bg-[#0F0F0F] relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(ellipse 70% 50% at 50% 50%, rgba(134,140,149,0.5) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(134,140,149,0.15) 0%, rgba(30,25,10,0.8) 100%)',
              border: '1px solid rgba(134,140,149,0.4)',
            }}
          >
            <div className="text-4xl mb-4" style={{ color: '#868C95' }}>◈</div>
          ...
          <div className="space-y-6">
            ...
            <div className="card-dark rounded-xl p-6">
              <div className="text-2xl mb-3" style={{ color: '#868C95' }}>✉</div>
