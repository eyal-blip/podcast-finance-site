...
const latestPosts = [
  { title: '2026 – שנה של ניהול סיכונים', author: 'ד"ר איתי גלילי', date: '1.1.26', category: 'סקירת שווקים', href: 'https://nihulhon.co.il/posts/האם-ישראל-יכולה-לממן-את-התוכנ', excerpt: 'השווקים הפיננסיים מסיימים את שנת 2025 בתשואות נאות. שוק ההון הישראלי בולט לחיוב על רקע סיום המלחמה. המדד המוביל רשם עלייה של כ-20% בשנה שעברה, ושיעורי האינפלציה מתמתנים. עם זאת, אי-הוודאות הגיאופוליטית האזורית ממשיכה לשמש גורם סיכון מרכזי לתיקי ההשקעות.' },
  { title: 'סקירת שווקים לקראת 2026', author: 'מיכל יוזפסון', date: '1.1.26', category: 'סקירת שווקים', href: 'https://nihulhon.co.il/posts/סקירת-שווקים-לקראת-רבעון-שני', excerpt: 'שווקי המניות הגלובליים הציגו ביצועים חזקים, למרות ריבוי זעזועים פוליטיים וגיאופוליטיים. ה-S&P 500 ומדדי אירופה סיימו השנה בעליות משמעותיות. הריבית בארה"ב מתייצבת והפד מסמן הפחתות נוספות ב-2026, מה שתומך בסביבת השקעות חיובית.' },
  { title: 'האם ישראל יכולה לממן את תוכנית הבינה המלאכותית?', author: 'ד"ר איתי גלילי', date: '20.9.25', category: 'מדיניות', href: 'https://nihulhon.co.il/posts/מבט-אל-המציאות-של-שנת-2050', excerpt: 'בשנתיים האחרונות המהפכה הטכנולוגית בתחום הבינה המלאכותית יצאה מתחומי מוסדות המחקר לשימושים יומיומיים. ממשלת ישראל הכריזה על תוכנית לאומית בהיקף של עשרות מיליארדים, אך שאלת המימון נשארת פתוחה. האם הגרעון התקציבי מאפשר השקעה כזאת, ומה המחיר לדחות אותה?' },
  { title: 'סקירת שווקים רבעון שלישי 2025', author: 'מיכל יוזפסון', date: '20.9.25', category: 'סקירת שווקים', href: 'https://nihulhon.co.il/posts/סקירת-שווקים-דצמבר-2024-1', excerpt: 'המומנטום החיובי בשווקי המניות והאג"ח נמשכו אל תוך שנת 2025 והביאו את השווקים לשיאים חדשים. מניות הטכנולוגיה מובילות את המגמה, עם ביצועים יוצאי דופן בסקטור הבינה המלאכותית. שוק האג"ח מייצב עם ירידת תשואות, המשפרת את סביבת המימון לחברות.' },
  { title: 'סקירת שווקים לקראת רבעון שני 2025', author: 'מיכל יוזפסון', date: '1.4.25', category: 'סקירת שווקים', href: 'https://nihulhon.co.il/posts/סקירת-שווקים-דצמבר-2024', excerpt: 'שנת 2025 נפתחה במומנטום חיובי בשווקי המניות והאג"ח, עם תחזיות צמיחה יציבות לכלכלה הגלובלית. ירידת האינפלציה בארה"ב ובאירופה יצרה ציפיות להפחתות ריבית נוספות. שווקים מתפתחים מציגים ביצועים משתפרים על רקע היחלשות הדולר.' },
  { title: 'על כוחם של תאגידים וכישלונן של ממשלות', author: 'ד"ר איתי גלילי', date: '1.4.25', category: 'מאמר דעה', href: 'https://nihulhon.co.il/posts/על-כוחם-של-תאגידים-וכישלונן-ש', excerpt: 'ישראל נמצאת בתקופה מאתגרת מאוד בהיבט הביטחוני, הפוליטי והחברתי. בעוד הממשלה מתקשה להוביל רפורמות מבניות, תאגידים גדולים ממלאים ריק שלטוני גובר. מה המשמעות הכלכלית של תופעה זו, ואיך היא משפיעה על המשקיעים לטווח ארוך?' },
  { title: 'השקעה בקרנות גידור — מה שצריך לדעת', author: 'ד"ר איתי גלילי', date: '1.9.24', category: 'השקעות', href: 'https://nihulhon.co.il/posts/', excerpt: 'קרנות גידור הן כלי השקעה המיועד בעיקר למשקיעים כשירים בעלי הון גבוה. הן מפעילות אסטרטגיות מגוונות — לונג-שורט, מאקרו גלובלי, ארביטראז׳ — כדי לייצר תשואה בלתי-מתואמת עם השוק. החסרונות: דמי ניהול גבוהים, נזילות מוגבלת ושקיפות חלקית.' },
  { title: 'תכנון פנסיוני בגיל 50 — עדיין לא מאוחר', author: 'מיכל יוזפסון', date: '1.6.24', category: 'פנסיה', href: 'https://nihulhon.co.il/posts/', excerpt: 'גם בגיל 50 אפשר לשפר משמעותית את מצב הפנסיה. הצעדים הקריטיים: בדיקת דמי ניהול ומעבר לקרן זולה יותר, הגדלת הפקדות כולל הטבות מס, ובחירת מסלול השקעה המתאים לגיל ולסיכון. הזמן שנותר עד הפרישה מאפשר עדיין צבירה משמעותית נוספת.' },
  { title: 'ניהול הון בעידן האינפלציה', author: 'ד"ר איתי גלילי', date: '1.3.24', category: 'מאקרו', href: 'https://nihulhon.co.il/posts/', excerpt: 'סביבה אינפלציונית שוחקת ערך ריאלי של נכסים נזילים. ההגנות המקובלות: נדל"ן מניב, מניות סקטורים אנרגיה וסחורות, אג"ח צמודות מדד וזהב. בניית תיק עמיד לאינפלציה דורשת פיזור נכון בין נכסים ריאליים לנומינליים.' },
]
