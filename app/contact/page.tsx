    ...
    <div className="min-h-screen bg-[#F8F3E8]">
      <div className="bg-[#1E3651] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black mb-4">פגישת <span style={{ background: 'linear-gradient(135deg, #868C95 0%, #A8AEB8 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>ייעוץ</span></h1>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {[
              ...
              <a key={c.label} href={c.href} target={c.href.startsWith('http') ? '_blank' : undefined} rel="noopener noreferrer"
                ...
                <div className="w-11 h-11 rounded-full flex items-center justify-center text-lg flex-shrink-0"
                  style={{ background: 'rgba(134,140,149,0.1)', color: '#6A7280' }}>
                  {c.icon}
                </div>
                <div>
                  <div className="text-xs text-[#8C7B65] mb-0.5">{c.label}</div>
                  <div className="font-semibold text-[#1E3651] group-hover:text-[#6A7280] transition-colors">{c.value}</div>
                </div>
          ...
          {/* Info */}
          <div>
            <h2 className="text-xl font-bold text-[#1E3651] mb-6">פגישת ייעוץ</h2>
            <div className="card-ivory rounded-2xl p-7 shadow-sm mb-6">
              <div className="text-3xl mb-4" style={{ color: '#868C95' }}>◈</div>
              <h3 className="text-lg font-bold text-[#1E3651] mb-3">ייעוץ ראשוני — ללא עלות</h3>
            ...
            <div className="card-ivory rounded-xl p-5 flex items-start gap-3">
              ...
              <div>
                <div className="font-semibold text-[#1E3651] text-sm mb-1">כתובת</div>
